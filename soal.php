...
?>
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
		 ...
		 <tr><td valign='top'><h4>Nilai anda   </h4>         </td><td valign='top'><h2 style='color: blue;'> $t[score]</h2></td></tr></table></div>";
			...
			echo ' <div style="background-color: #F0FFF0;margin-top: -35px; margin-left:15%;margin-right:15%; ">
			<center>  <h3  > Waktu Ujian Online</h3>
			<h4 ><span style="align:center;color: red;font-size:18px"><span id="menit"></span>:<span id="detik"></span></span> </h4> </center>	
             </div>';
			
//--> atur  panjang dan lebar buat kotak box float/scrol untuk tabel soal
			echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:850px;'>";  
