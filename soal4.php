...
<?php 
      ...
      echo ' <div style="background-color: #F0FFF0;margin-top: -5px; margin-left:1%;margin-right:1%;border: 1px dotted green; "> 
      <center>  <h6  > Waktu</h6>
...
<br> <br>
            ...
            <div class="panel-heading"  style="margin-top: -4px;background-color:  #DCDCDC;height: 35px;">
              <table>
               <tr><td valign='top'><button style="background:#FFFAF0 ; height: 4;width: 100; border: 1px;" onclick="openFullscreen()" style="color: white;"  ><a href="#" style="text-decoration:none">Full Screen</a></button> </td><td>&nbsp;</td>
                <td valign='top'> <button style="background:#FFFAF0; height: 4;width: 150;border: 1px;" onclick="closeFullscreen()" style="color: white;"  > <a href="#" style="text-decoration:none">Normal Screen</a></button> </td></tr>  
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
     ...
     <tr><td valign='top'><h4>Nilai anda   </h4>         </td><td valign='top'><h2 style='color: blue;'> $t[score]</h2></td></tr></table></div>";
      ...
      echo '<table width="100%" border="0"  id="Table2" style="margin-top: 40px;"  >';
     ...
     while ($row = mysqli_fetch_array($hasil)) {
          ...
          <form  name="form1" method="post" action="?hal=jawaban">  
                      ...
                      <tr>
                        <td width="10" valign="top"class='cell0'>
                      ...
                      <?php
                      if (!empty($row["gambar"])) {
                        echo "<tr><td></td><td colspan='6'><img src='foto/$row[gambar]' width='200' hight='200'></td></tr>";
                      }
...
<td colspan='4' class='cell12'><?php echo "$pilihan_a"; ?></td>
</tr>
...
<td colspan='4' class='cell12'><?php echo "$pilihan_b"; ?></td>
</tr>
...
<td colspan='4' class='cell12'><?php echo "$pilihan_c"; ?></td>
</tr>
...
<td colspan='4' class='cell12'><?php echo "$pilihan_d"; ?></td>
</tr>
...
<td colspan='4' class='cell12'><?php echo "$pilihan_e"; ?></td>
 <?php
}
 echo "
</tr>
...
<center>
<button style="background-color: #FFA500; margin-top: 5%; padding: 15px;" onclick="ruki()"><h1>&nbsp; Jawab | Selesai &nbsp;</h1></button>
</center>
