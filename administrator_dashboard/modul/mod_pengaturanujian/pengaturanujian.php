                ...
                <div class="panel panel-primary">
                  ...
                  <div class="panel-body">
                    ...
                    switch ($_GET['act']) {
                        // Tampil Menuatas
                      default:
                        $sql  = mysqli_query($mysqli, "SELECT * FROM tbl_pengaturan_ujian");



  //--> atur  panjang dan lebar buat kotak box float/scrol untuk tabel soal
      echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:850px;'>";                        $r    = mysqli_fetch_array($sql);
          ...
          <div class='form-group'>
            <label for='inputEmail3' class='col-sm-2 control-label'>Waktu Pengerjaan (menit) </label>
            <div class='col-sm-5'>
          ...
          <div class='form-group'>
            <label for='inputEmail3' class='col-sm-2 control-label'>Nilai Minimum (max 100)</label>
            <div class='col-sm-5'>
          ...
          <div class='form-group'>
            ...
            <div class='col-sm-10'>
              <textarea name='peraturan' style='width: 270px; height: 350px;'>$r[peraturan]</textarea>
            </div>
          </div>
